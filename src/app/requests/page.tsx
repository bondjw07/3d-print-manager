      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          {requests.length === 0 ? (
            ...
            <>
              <div className="hidden rounded-xl border border-slate-200 bg-slate-50 px-4 py-2 text-xs font-semibold uppercase tracking-wide text-slate-500 lg:grid lg:grid-cols-[minmax(0,2fr)_auto_auto_7rem_minmax(0,2fr)_auto] lg:items-center lg:gap-3">
                <p>Model</p>
                <p>Status</p>
                <p>Submitted</p>
                <p>Quantity</p>
                ...
                {requests.map((request) => {
                  ...
                  return (
                    <form
                      ...
                      className="grid gap-3 rounded-xl border border-slate-200 bg-white/90 p-4 lg:grid-cols-[minmax(0,2fr)_auto_auto_7rem_minmax(0,2fr)_auto] lg:items-center"
                    >
